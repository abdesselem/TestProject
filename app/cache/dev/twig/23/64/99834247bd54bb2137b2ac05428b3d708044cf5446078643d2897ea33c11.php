...
class __TwigTemplate_236499834247bd54bb2137b2ac05428b3d708044cf5446078643d2897ea33c11 extends Twig_Template
{
...
";
    ...
    <thead>
        <tr>
            <th colspan=\"3\">";
                // line 10
                echo $this->env->getExtension('sylius_resource')->renderSortingLink($this->env, "name", $this->env->getExtension('translator')->trans("sylius.taxonomy.name"));
                echo "</th>
        </tr>
    </thead>
    <tbody>
            ...
            <td>
                ";
                    ...
                    if (((!(null === $this->getAttribute((isset($context["taxonomy"]) ? $context["taxonomy"] : $this->getContext($context, "taxonomy")), "root"))) && (twig_length_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["taxonomy"]) ? $context["taxonomy"] : $this->getContext($context, "taxonomy")), "root"), "path")) > 0))) {
                        ...
                        <a href=\"";
                        // line 24
                        echo twig_escape_filter($this->env, $this->env->getExtension('liip_imagine')->filter($this->getAttribute($this->getAttribute((isset($context["taxonomy"]) ? $context["taxonomy"] : $this->getContext($context, "taxonomy")), "root"), "path"), "sylius_large"), "html", null, true);
                        echo "\"  data-gallery=\"gallery\" title=\"";
                        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["taxonomy"]) ? $context["taxonomy"] : $this->getContext($context, "taxonomy")), "name"), "html", null, true);
                        echo "\">
                            <img src=\"";
                        // line 25
                        echo twig_escape_filter($this->env, $this->env->getExtension('liip_imagine')->filter($this->getAttribute($this->getAttribute((isset($context["taxonomy"]) ? $context["taxonomy"] : $this->getContext($context, "taxonomy")), "root"), "path"), "sylius_small"), "html", null, true);
