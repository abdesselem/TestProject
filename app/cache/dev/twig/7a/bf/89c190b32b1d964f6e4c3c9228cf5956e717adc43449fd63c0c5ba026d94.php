...
class __TwigTemplate_7abf89c190b32b1d964f6e4c3c9228cf5956e717adc43449fd63c0c5ba026d94 extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_ded876773c8259ff8028679d09451aa811f6088d6b9be0e61b744c6de7f33535"] = $this->env->loadTemplate("SyliusWebBundle:Backend/Order:macros.html.twig");
        // line 4
        $context["__internal_9bce4d04d5f7439325a562d53206546a4e461ac69727db75e4c82e61c38edda3"] = $this->env->loadTemplate("SyliusWebBundle:Backend/User:macros.html.twig");
...
<div class=\"row\">
    ...
    <div class=\"col-md-6\">
        ...
        echo "</td>
                    <td>";
        // line 34
        echo twig_escape_filter($this->env, $this->env->getExtension('sylius_money')->formatPrice((isset($context["sales"]) ? $context["sales"] : $this->getContext($context, "sales"))), "html", null, true);
        echo " (";
        echo twig_escape_filter($this->env, $this->env->getExtension('sylius_money')->formatPrice((isset($context["sales_confirmed"]) ? $context["sales_confirmed"] : $this->getContext($context, "sales_confirmed"))), "html", null, true);
        echo ")</td>
                </tr>
                <tr>
                    <td>";
...
<div class=\"row\">
    <div class=\"col-md-6\">
        ";
        // line 51
        echo $context["__internal_ded876773c8259ff8028679d09451aa811f6088d6b9be0e61b744c6de7f33535"]->getsimple_list((isset($context["orders"]) ? $context["orders"] : $this->getContext($context, "orders")));
        echo "
        <a href=\"";
        // line 52
        echo $this->env->getExtension('routing')->getPath("sylius_backend_order_index");
    ...
    <div class=\"col-md-6\">
        ";
        // line 55
        echo $context["__internal_9bce4d04d5f7439325a562d53206546a4e461ac69727db75e4c82e61c38edda3"]->getsimple_list((isset($context["users"]) ? $context["users"] : $this->getContext($context, "users")));
        echo "
        <a href=\"";
        // line 56
        echo $this->env->getExtension('routing')->getPath("sylius_backend_user_index");
