...
/* SyliusWebBundle:Backend/ProductPrototype:macros.html.twig */
class __TwigTemplate_ecd3f4c76926cc6c1f8526c6f3a74f12683c0929bd5b8b81d4c6142e9feb13fd extends Twig_Template
{
...
";
    ...
    <thead>
        <tr>
            ...
            <th>";
                // line 11
                echo $this->env->getExtension('sylius_resource')->renderSortingLink($this->env, "name", $this->env->getExtension('translator')->trans("sylius.prototype.name"));
                echo "</th>
            <th>";
                // line 12
            ...
            <th>";
                // line 13
                echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("sylius.prototype.attributes"), "html", null, true);
                echo "</th>
            <th>";
                // line 14
                echo $this->env->getExtension('sylius_resource')->renderSortingLink($this->env, "updatedAt", $this->env->getExtension('translator')->trans("sylius.prototype.updated_at"));
                echo "</th>
            <th></th>
        </tr>
    </thead>
    ...
    ";
            ...
            <td>
                <ul>
                    ...
                    // line 32
                    $context['_parent'] = (array) $context;
                    $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["prototype"]) ? $context["prototype"] : $this->getContext($context, "prototype")), "attributes"));
            ...
            <td>
                ...
                ";
                    // line 40
                    echo $context["buttons"]->getshow($this->env->getExtension('routing')->getPath("sylius_backend_product_prototype_build", array("id" => $this->getAttribute((isset($context["prototype"]) ? $context["prototype"] : $this->getContext($context, "prototype")), "id"))), $this->env->getExtension('translator')->trans("sylius.prototype.build"));
                    echo "
                ";
                    // line 41
                    echo $context["buttons"]->getedit($this->env->getExtension('routing')->getPath("sylius_backend_product_prototype_update", array("id" => $this->getAttribute((isset($context["prototype"]) ? $context["prototype"] : $this->getContext($context, "prototype")), "id"))));
                    echo "
                ";
                    // line 42
                    echo $context["buttons"]->getdelete($this->env->getExtension('routing')->getPath("sylius_backend_product_prototype_delete", array("id" => $this->getAttribute((isset($context["prototype"]) ? $context["prototype"] : $this->getContext($context, "prototype")), "id"))));
                    echo "
                </div>
            </td>
        </tr>
...
";
    ...
    {
        return "SyliusWebBundle:Backend/ProductPrototype:macros.html.twig";
    }
