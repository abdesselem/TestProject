...
/* SyliusWebBundle:Backend/ProductOption:macros.html.twig */
class __TwigTemplate_471b32339f170f74dedaf5484342ddebce2506839ccf783ccf70ce6f3709e8b5 extends Twig_Template
{
...
";
        ...
        <thead>
            <tr>
                ...
                <th>";
                // line 11
                echo $this->env->getExtension('sylius_resource')->renderSortingLink($this->env, "name", $this->env->getExtension('translator')->trans("sylius.product_option.name"));
                echo "</th>
                <th>";
                // line 12
                echo $this->env->getExtension('sylius_resource')->renderSortingLink($this->env, "presentation", $this->env->getExtension('translator')->trans("sylius.product_option.presentation"));
                echo "</th>
                <th>";
                // line 13
                ...
                <th>";
                // line 14
                echo $this->env->getExtension('sylius_resource')->renderSortingLink($this->env, "updatedAt", $this->env->getExtension('translator')->trans("sylius.product_option.updated_at"));
                echo "</th>
                <th></th>
            </tr>
        </thead>
        ...
        ";
                ...
                <td>
                    ...
                    ";
                    // line 34
                    echo $context["buttons"]->getedit($this->env->getExtension('routing')->getPath("sylius_backend_product_option_update", array("id" => $this->getAttribute((isset($context["option"]) ? $context["option"] : $this->getContext($context, "option")), "id"))));
                    echo "
                    ";
                    // line 35
                    echo $context["buttons"]->getdelete($this->env->getExtension('routing')->getPath("sylius_backend_product_option_delete", array("id" => $this->getAttribute((isset($context["option"]) ? $context["option"] : $this->getContext($context, "option")), "id"))));
                    echo "
                   </div>
                </td>
            </tr>
...
";
                ...
                // line 43
                echo $context["alerts"]->getinfo($this->env->getExtension('translator')->trans("sylius.product_option.no_results"));
                echo "
";
            }
            // line 45
...
";
    ...
    {
        return "SyliusWebBundle:Backend/ProductOption:macros.html.twig";
    }
