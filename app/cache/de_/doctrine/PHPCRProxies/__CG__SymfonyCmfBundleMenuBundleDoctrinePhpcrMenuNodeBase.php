...
class MenuNodeBase extends \Symfony\Cmf\Bundle\MenuBundle\Doctrine\Phpcr\MenuNodeBase implements \Doctrine\Common\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'children', 'label', 'uri', 'route', 'attributes', 'childrenAttributes', 'linkAttributes', 'labelAttributes', 'extras', 'routeParameters', 'display', 'displayChildren', 'routeAbsolute');
        }
     ...
     * {@inheritDoc}
     */
    public function removeChild(\Symfony\Cmf\Bundle\MenuBundle\Model\MenuNode $child)
    {
