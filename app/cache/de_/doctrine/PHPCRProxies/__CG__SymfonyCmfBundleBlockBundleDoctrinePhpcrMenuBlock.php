 ...
 */
class MenuBlock extends \Symfony\Cmf\Bundle\BlockBundle\Doctrine\Phpcr\MenuBlock implements \Doctrine\Common\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Symfony\\Cmf\\Bundle\\BlockBundle\\Doctrine\\Phpcr\\MenuBlock' . "\0" . 'menuNode', 'id', 'name', 'parentDocument', 'ttl', 'settings', 'createdAt', 'updatedAt', 'publishable', 'publishStartDate', 'publishEndDate', 'locale');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MenuBlock $proxy) {
    ...
    public function getMenuNode()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMenuNode', array());

        return parent::getMenuNode();
    }

    /**
     * {@inheritDoc}
     */
    public function setMenuNode(\Knp\Menu\NodeInterface $menuNode = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMenuNode', array($menuNode));

        return parent::setMenuNode($menuNode);
    }
